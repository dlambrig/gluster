...
int
cachetier_lookup (call_frame_t *frame, xlator_t *this,
...
int
cachetier_create (call_frame_t *frame, xlator_t *this,
             ...
             mode_t umask, fd_t *fd, dict_t *params)
{
        ...
        if (subvol != avail_subvol) {
                ...
                dht_linkfile_create (frame, cachetier_create_linkfile_create_cbk,
...
int
cachetier_mknod_linkfile_cbk (call_frame_t *frame, void *cookie, xlator_t *this,
...
int
cachetier_mknod (call_frame_t *frame, xlator_t *this,
            loc_t *loc, mode_t mode, dev_t rdev, mode_t umask, dict_t *params)
{
        ...
        if (avail_subvol != subvol) {
                ...
                dht_linkfile_create (frame, cachetier_mknod_linkfile_cbk, this,
...
static void
cachetier_find_local_brick (xlator_t *xl, void *data)
{
        cachetier_args_t     *args = data;
...
static void
cachetier_to_dht (xlator_t *this)
{
        GF_ASSERT (this);
        GF_ASSERT (this->fops);
...
int
cachetier_find_local_subvol (xlator_t *this,
                        void (*fn) (xlator_t *each, void* data), void *data)
{
        ...
        while (trav) {
                ...
                parent = trav->xlator;
                if (strcmp (parent->type, "cluster/cachetier") == 0) {
