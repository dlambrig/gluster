...
#if 0
        MAKE_HANDLE_GFID_PATH(real_path, this, uuid_req, NULL);

        ret = sys_lsetxattr (real_path, GFID_XATTR_KEY, uuid_req, 16, XATTR_CREATE);
        gf_log (this->name, GF_LOG_DEBUG,
		"post-operation lstat on %d %d DAN %s ",ret, errno, real_path);
#endif
